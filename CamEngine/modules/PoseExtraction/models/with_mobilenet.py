...
if __name__ == "__main__":
    ...
    cfg = [[30, 30, 56, 56, 74, 74, 54, 54, 128, 128, 143, 143, 210, 210, 319, 319, 300, 300, 284, 284, 304, 304, 304], [126, 126, 126, 126, 126, 126, 126, 128]]
    model = PoseEstimationWithMobileNet_new(cfg)
    # print(model)
