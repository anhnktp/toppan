...
# #parser.add_argument("--ckpt", default=80, type=int)
# parser.add_argument("--weights",default="/mnt/hdd3tb/Users/anhtran/blitznet/archive/BlitzNet300_x4_VOC07_det/model.ckpt-80000",help="Path to ckpt model")
#
...
# parser.add_argument("--detect", default=True, action='store_true')
#
...
# parser.add_argument("--eval_min_conf", default=0.7, type=float)
#
...
if trunk == 'resnet50' and x4 and image_size == 300:
    config = config_resnet_x4
if trunk == 'resnet50' and x4 and image_size == 512:
    config = config_resnet_ssd512_x4
if trunk == 'vgg16' and x4:
    raise NotImplementedError
if trunk in ['resnet50', 'resnet101'] and not x4 and image_size == 300:
    config = config_resnet_nox4
if trunk in ['resnet50', 'resnet101'] and not x4 and image_size == 512:
    config = config_resnet_ssd512_nox4
if trunk == 'vgg16' and not x4:
    config = config_vgg
